    ...
    <div className="space-y-4">
      ...
      {!imageSrc ? (
        ...
        <div className="flex flex-col items-center space-y-4 bg-slate-50 p-5 rounded-2xl border border-slate-200 shadow-xs max-w-sm mx-auto">
          ...
          <p className="text-center text-[11px] text-slate-500 font-medium px-2 flex items-center justify-center gap-1">
            <svg className="h-3.5 w-3.5 text-amber-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>
            <span><b>Mẹo:</b> Kéo ảnh trực tiếp bằng chuột để di chuyển, cuộn chuột hoặc dùng thanh trượt để phóng to/thu nhỏ.</span>
          </p>
