      ...
      <div className="w-full max-w-md">
        <div className="rounded-lg bg-white shadow-lg p-8">
          ...
          <p className="text-sm text-center text-slate-600 mb-6">
            Nhập email sinh viên/hệ thống hoặc email cá nhân đã đăng ký để nhận hướng dẫn đặt lại mật khẩu
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-slate-700 mb-1">
                Email hệ thống hoặc Email cá nhân
              </label>
              <input
                id="email"
                type="email"
                ...
                placeholder="VD: 2026xxxx@student.edu.vn hoặc email@gmail.com"
